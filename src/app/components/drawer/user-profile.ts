...
@Component({
  ...
  template: `
    ...
    <nz-drawer [nzVisible]="visible" [nzWidth]="640" [nzClosable]="false" (nzOnClose)="close()">
      <ng-container *nzDrawerContent>
        <p class="mb-[25px] text-theme-gray dark:text-white/60" >User Profile</p>
  ...
  styles: [
    ...
    :host ::ng-deep .ant-list-item-meta-avatar{
      @apply mr-auto me-[10px];
    }
     :host ::ng-deep .ant-list-item-meta-title > a{
        @apply dark:text-white/[.87];
     }
     :host ::ng-deep .ant-list-item-action > li{
      @apply text-light dark:text-white/60;
     }
     :host ::ng-deep .ant-list-split .ant-list-item{
      @apply border-regular dark:border-white/10;
     }
     :host ::ng-deep .ant-list-item-meta-description{
        @apply text-light dark:text-white/60;
      }
    `
  ]
